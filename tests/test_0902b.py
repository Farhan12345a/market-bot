...
check("the stream cap moved to 60 on 2026-09-24, scaled with the wider "
      "watchlist (Algo Trader Plus has no subscription-count ceiling)",
      t["stream_max_subscriptions"] == 60)
